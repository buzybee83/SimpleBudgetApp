...
export async function insert(table: string, fields: Record<string, any>): Promise<void> {
...
export async function update(table: string, fields: Record<string, any>, id: string): Promise<void> {
